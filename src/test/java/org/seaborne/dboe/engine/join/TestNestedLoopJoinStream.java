...
/** Tests the right-streaming inner loop join */ 
public class TestNestedLoopJoinStream extends AbstractTestJoin1 {

    @Override
    public <X> RowList<X> join(JoinKey joinKey , RowList<X> left , RowList<X> right , RowOrder<X> comparator ) {
        return NestedLoopJoin.nestedLoopJoin(left, right, new RowBuilderBase<X>());
    }
